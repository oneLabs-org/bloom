...
First off, thank you for considering contributing to `Bloom-Backend`. This guide details all the general information that one should know before contributing to the project.
...
```
git clone https://github.com/<YOUR_USER_NAME>/Bloom-Backend.git
```
...
```
git remote add upstream https://github.com/blossomlabsio/Bloom-Backend.git
```
